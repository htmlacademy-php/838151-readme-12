    ...
    <form class="registration__form form" action="/registration.php" method="post" enctype="multipart/form-data">
        <div class="form__text-inputs-wrapper">
            <div class="form__text-inputs">
                <div class="registration__input-wrapper form__input-wrapper <?php if (!empty($errors['email'])) {
                ...
                <div class="registration__input-wrapper form__input-wrapper <?php if (!empty($errors['login'])) {
                    print(' form__input-section--error');
                } ?>">
                ...
                <div class="registration__input-wrapper form__input-wrapper <?php if (!empty($errors['password'])) {
                    print(' form__input-section--error');
                } ?>">
                    ...
                    <div class="form__input-section">
                        <input class="registration__input form__input" id="registration-password" type="password"
                               name="password" placeholder="Придумайте пароль" value="<?= getPostVal('password') ?>">
                        <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span>
                        </button>
                        <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                ...
                <div
                    class="registration__input-wrapper form__input-wrapper <?php if (!empty($errors['password-repeat'])) {
                        print(' form__input-section--error');
                    } ?>">
                    ...
                    <?php foreach ($errors as $key => $value): ?>
                        <li class="form__invalid-item">
                            ...
                            <?php case 'password': ?>
                                Пароль.
                                <?php break; ?>
                            <?php case 'password-repeat': ?>
                                Повтор пароля.
                                <?php break; ?>
                            <?php case 'userpic-file': ?>
                                Аватар.
                                <?php break; ?>
                            <?php endswitch; ?>
                            <?= $value ?>
        ...
        <input class="registration__input-file " id="userpic-file" type="file" name="userpic-file" title=" ">
