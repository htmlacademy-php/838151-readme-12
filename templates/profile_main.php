            ...
            <div class="profile__user user container">
                <div class="profile__user-info user__info">
                    <div class="profile__avatar user__avatar">
                        <img class="profile__picture user__picture" src="uploads/<?= $user[0]['avatar'] ?>" alt="Аватар пользователя">
                    </div>
                    <div class="profile__name-wrapper user__name-wrapper">
                        <span class="profile__name user__name"><?= $user[0]['name']; ?></span>
                        <time class="profile__user-time user__time" datetime="<?= $user[0]['registration_date]']; ?>"><?= checkTime($user[0]['registration_date']) ?></time>
                    </div>
                </div>
                <div class="profile__rating user__rating">
                    <p class="profile__rating-item user__rating-item user__rating-item--publications">
                        <span class="user__rating-amount"><?= $user[0]['count_post'] ?></span>
                        <span class="profile__rating-text user__rating-text">публикаций</span>
                    </p>
                    <p class="profile__rating-item user__rating-item user__rating-item--subscribers">
                        <span class="user__rating-amount"><?= $user[0]['count_subs'] ?></span>
                                    ...
                                    <img src="img/rock.jpg" alt="Фото от пользователя" width="760" height="396">
                                                ...
                                                <footer class="post__footer">
                                                    <div class="post__indicators">
                                                        ...
                                                        <time class="post__time" datetime="2019-01-30T23:41"><?= checkTime($val['date']) ?></time>
                                                    </div>
                                                    <ul class="post__tags">
