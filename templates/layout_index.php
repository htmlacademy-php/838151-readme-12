        ...
        <section class="authorization">
            ...
            <form class="authorization__form form" action="index.php" method="post">
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div class="form__input-section <?php if(!empty($errors['login'])){print('form__input-section--error');}?>">
                ...
                <div class="authorization__input-wrapper form__input-wrapper">
                    <div class="form__input-section <?php if(!empty($errors['password'])){print('form__input-section--error');}?>">
